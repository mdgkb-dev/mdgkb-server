...
type IService interface {
	CreateMany(teachers models.ResidencyCoursesSpecializations) error
}

type IRepository interface {
	db() *bun.DB
	createMany(models.ResidencyCoursesSpecializations) error
	upsertMany(models.ResidencyCoursesSpecializations) error
